...
use crate::{gc::NotGarbageCollected, persistent::KeyValueStoreBackend, ObjectHash};
...
impl IpcContextServer {
    ...
    pub fn process_context_requests(&self, log: &Logger) -> Result<(), IpcContextError> {
        ...
        loop {
            ...
            match cmd {
                ContextRequest::GetShape(shape_id) => match get_context_index() {
                ...
                ContextRequest::ContainsObject(hash) => match get_context_index() {
                ...
                ContextRequest::GetContextHashId(context_hash) => match get_context_index() {
                ...
                ContextRequest::GetHash(object_ref) => match get_context_index() {
                ...
                ContextRequest::GetObjectBytes(object_ref) => match get_context_index() {
                ...
                ContextRequest::GetHashId(object_ref) => match get_context_index() {
